...
--run_name="oneshot_lungs_run1" \
--instance_prompt="segmentation map of lung" \
--organ="lung" \
--resolution="512" \
--train_batch_size="1" \
...
--lr_warmup_steps=0 \
--seg_slices_pkl="/disk4/Lev/Projects/diffusion_finetuning/data/MSD/Task06_Lung/imagesFinetune/lungs_seg_good_slice.pickle" \
--vol_slices_pkl="/disk4/Lev/Projects/diffusion_finetuning/data/MSD/Task06_Lung/imagesFinetune/lungs_vol_good_slice.pickle" \
--resize="True" \
--max_train_steps=500 \
